...
1. Navigate to the AWA2 data directory:
```
cd ./AWA2
```
2. Download  the  "AwA2-data.zip" at [Animals with Attributes 2](https://cvml.ista.ac.at/AwA2/).  
2. Extract the data:
```
unzip AwA2-data.zip
```
...
# dataset dir
 ...
 Please update the "dataset_dir" variable in the relevant files (./lib/dataset/get_dataset.py) to match your local dataset path. 
