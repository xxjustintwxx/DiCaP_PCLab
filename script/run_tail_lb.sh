device_id=0
dataset_dir='./data'           # training scripts append dataset_name → ./data/cxr_tail_lb
eval_dataset_dir='./data/cxr_tail_lb'  # evaluate/plot scripts use this directly
dataset_name='cxr_tail_lb'
net='tresnet_l'
output='cxr_ours'
